<cfmodule template="customTags/siteChrome.cfm"  pageTitle="Reports"> 
    <cfscript>
        //  INITIALIZE THE farmer MANAGER --->
        qryAllFarmers = new logic.manager.farmerManager().getAllFarmers();
    </cfscript>
    ...
    <div class="container-fluid">
        <div class="row">
            <!--- Main body content --->
            <div class="ms-4 mt-4 bg-white h-100 sidebar col-12 col-sm-8 col-md-8 col-lg-9 col-xl-11 col-xxl-11">
                ...
                <cfif qryAllFarmers.RecordCount>
                    ...
                    <cfif isDefined("form.selectOutput") and form.selectOutput neq "screen">
                        <cfoutput>#rptAllFarmers#</cfoutput>
                    <cfelseif !isDefined("form.selectOutput")>
                        <cfoutput>#rptAllFarmers#</cfoutput>
                    </cfif>
